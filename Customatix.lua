...
game.StarterGui:SetCore("SendNotification", {Title = "Nameless <3", Text = "This script was made by Keanu Reeves#3227.", Icon = "http://www.roblox.com/asset/?id=6977874681", Duration = 3})
game.StarterGui:SetCore("SendNotification", {Title = "Nameless <3", Text = "Modified By Theo/Paradigm!, not skid",Duration = 5})
...
local modeInfo={
	{Name="Nameless",Walkspeed=20,moveVal=10,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=0,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='Space'};
...
local NECK,ROOTJOINT,RIGHTHIP,RIGHTSHOULDER,LEFTHIP,LEFTAHOULDER=unpack(welds)
...
local SWORD1 = WingPiece:Clone();
if MPASword[1] then
	for _,v in pairs(SWORD1:GetChildren()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
	end
	local athp = Instance.new("Attachment",SWORD1.PrimaryPart)
	local atho = Instance.new("Attachment",SWORD1.PrimaryPart)
...
SWORD1.Parent = leftWing
local SWORD2 = WingPiece:Clone();
if MPASword[1] then
	...
	local athp = Instance.new("Attachment",SWORD2.PrimaryPart)
	local atho = Instance.new("Attachment",SWORD2.PrimaryPart)
...
local SWORD3 = WingPiece:Clone();
if MPASword[1] then
	for _,v in pairs(SWORD3:GetChildren()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
	end
	local athp = Instance.new("Attachment",SWORD3.PrimaryPart)
	local atho = Instance.new("Attachment",SWORD3.PrimaryPart)
...
SWORD3.Parent = rightWing
local SWORD4 = WingPiece:Clone();
if MPASword[1] then
	for _,v in pairs(SWORD4:GetChildren()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
	end
	local athp = Instance.new("Attachment",SWORD4.PrimaryPart)
	local atho = Instance.new("Attachment",SWORD4.PrimaryPart)
...
local DAURA = WingPiece:Clone();
if game.Players.LocalPlayer.Character:FindFirstChild("Divine Aura") then -- Divine Aura
	for _,v in pairs(DAURA:GetChildren()) do
		if v:IsA("BasePart") then
			v.Transparency = 1
		end
	end
	local athp = Instance.new("Attachment",DAURA.PrimaryPart)
	local atho = Instance.new("Attachment",DAURA.PrimaryPart)
...
DAURA.Parent = rightWing
local S1=Weld(SWORD1.PrimaryPart,Torso,CF.N(2,-2,-1)*CF.A(0,0,0))
local S2=Weld(SWORD2.PrimaryPart,Torso,CF.N(4.25,-1,-1)*CF.A(0,0,M.R(15)))
local LWP3W=Weld(LWP3.PrimaryPart,Torso,CF.N(6.5,.5,-1)*CF.A(0,0,M.R(30)))
local S3=Weld(SWORD3.PrimaryPart,Torso,CF.N(-2,-2,-1)*CF.A(0,0,0))
local S4=Weld(SWORD4.PrimaryPart,Torso,CF.N(-4.25,-1,-1)*CF.A(0,0,M.R(-15)))
...
local DAURA=Weld(RWP7.PrimaryPart,Torso,CF.N(-6.5,.5,-1)*CF.A(0,0,M.R(-30)))
...
function syncStuff(data)
	...
	if(not neut)then
		...
		ROOTJOINT.C0=torso0
		RIGHTHIP.C0=rleg0
		RIGHTSHOULDER.C0=rarm0
		LEFTHIP.C0=lleg0
		LEFTAHOULDER.C0=larm0
		
		NECK.C1=head1
		ROOTJOINT.C1=torso1
		RIGHTHIP.C1=rleg1
		RIGHTSHOULDER.C1=rarm1
		LEFTHIP.C1=lleg1
		LEFTAHOULDER.C1=larm1
	end
	if(Mode~=mode)then
		changeMudo(mode)
	end
...
function Click1()
	...
	for i = 0, 1, 0.1 do
		swait()
		local Alpha = .3
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0),M.R(-44.6),M.R(0)),Alpha)
		LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.8,-1,-0.3)*CF.A(M.R(-17.4),M.R(44.4),M.R(7.1)),Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.4,-1,0)*CF.A(M.R(1.6),M.R(-13.1),M.R(7)),Alpha)
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.3,0.5,-0.3)*CF.A(M.R(90),M.R(0),M.R(-44.6)),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1.4,0.5,-0.1)*CF.A(M.R(90),M.R(0),M.R(-44.6)),Alpha)
		NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,0)*CF.A(M.R(0),M.R(44.6),M.R(0)),Alpha)
	end
	for i = 0, 1, 0.1 do
		swait()
		...
		local Alpha = .3
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0,-0.7)*CF.A(M.R(0),M.R(50.5),M.R(0)),Alpha)
		LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-0.7,-0.6)*CF.A(M.R(-26),M.R(0),M.R(0)),Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.6,-1.1,-0.1)*CF.A(M.R(20.2),M.R(-47.6),M.R(15.2)),Alpha)
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.3,0.5,0)*CF.A(M.R(0),M.R(0),M.R(-20.4)),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1.4,0.5,-0.5)*CF.A(M.R(90),M.R(0),M.R(50.5)),Alpha)
		NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,0)*CF.A(M.R(0),M.R(-50.5),M.R(0)),Alpha)
	end
	WalkSpeed=orig
	legAnims=true
	Attack=false
...
function SwordSummon()
	...
	for i = 0, 1, 0.1 do
		...
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,-0.2,-0.1)*CF.A(M.R(-12.4),M.R(-15.7),M.R(0)),Alpha)
		LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-0.7,-0.5)*CF.A(M.R(16.2),M.R(15.2),M.R(-0.8)),Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.5,-1,0)*CF.A(M.R(-28.5),M.R(0),M.R(0)),Alpha)
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.4,0.5,0)*CF.A(M.R(27.2),M.R(-3.8),M.R(-5)),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1.3,0.6,0)*CF.A(M.R(-33.8),M.R(-18.1),M.R(24.8)),Alpha)
		NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,0)*CF.A(M.R(13.4),M.R(15.3),M.R(-3.6)),Alpha)
	end

	for i = 0, 1, 0.1 do
		swait()
		local Alpha = .3
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0),M.R(70.7),M.R(0)),Alpha)
		LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(0),M.R(0),M.R(-14.4)),Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.6,-1,0)*CF.A(M.R(15.1),M.R(-63.2),M.R(13.5)),Alpha)
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.3,0.6,-0.1)*CF.A(M.R(0),M.R(15.9),M.R(-25.4)),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1.4,0.3,-0.2)*CF.A(M.R(0),M.R(19.3),M.R(157.1)),Alpha)
		NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,0)*CF.A(M.R(0),M.R(-70.7),M.R(0)),Alpha)
	end
	legAnims=true
	WalkSpeed=orig
	Attack = false
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.Three and Mode~='Jack of All Trades')then 
		changeMode'Jack of All Trades' VaporTaunt()
	
	elseif(io.KeyCode == Enum.KeyCode.Four and Mode~='Darkness')then 
		changeMode'Darkness' VaporTaunt()
	...
	elseif(io.KeyCode == Enum.KeyCode.Seven and Mode~='V I B E R')then 
		changeMode'V I B E R' VaporTaunt()
	...
	elseif(io.KeyCode == Enum.KeyCode.X and Mode~='Awakened')then
	    changeMode'Awakened' VaporTaunt()
    ...
    elseif(io.KeyCode == Enum.KeyCode.B and Mode~='Hardbass')then
	    changeMode'Hardbass' VaporTaunt() 
	elseif(io.KeyCode == Enum.KeyCode.L and Mode~='Unmerciful')then 
		changeMode'Unmerciful' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.K and Mode~='The True Ending')then 
		changeMode'The True Ending' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.G and Mode~='The Big Black')then 
		changeMode'The Big Black' VaporTaunt() 
	elseif(io.KeyCode == Enum.KeyCode.J and Mode~='~Funky~')then 
		changeMode'~Funky~' VaporTaunt() 
	elseif(io.KeyCode == Enum.KeyCode.H and Mode~='Eternal Demise')then 
		changeMode'Eternal Demise' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Nameless')then 
		changeMode'Lost Soul'
	elseif(io.KeyCode == Enum.KeyCode.U and Mode~='Determination')then
	    changeMode'Determination' VaporTaunt()
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Awakened')then 
		changeMode'Supercharged' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Determination')then 
		changeMode'Murderous' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Unmerciful')then 
		changeMode'Elysian' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Hardbass')then 
		changeMode'C a r' VaporTaunt()
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Unholy')then 
		changeMode'Holy' 
	elseif(io.KeyCode == Enum.KeyCode.N and Mode~='Ancient')then 
		changeMode'Ancient'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='Legendary')then 
		changeMode'Hacker' VaporTaunt()
	--TOGGLE MUSIC
...
WingAnims.Crazed=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(40,4,-4)*CF.A(M.R(15-0*M.C(WingSine/32)),0,M.R(30+40*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-40,4,-4)*CF.A(M.R(15-0*M.C(WingSine/32)),0,M.R(-30-40*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-4,.5,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-30,6,-3)*CF.A(M.R(15-0*M.C(WingSine/32)),0,M.R(-30-35*M.C(WingSine/32))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(30,6,-3)*CF.A(M.R(15-0*M.C(WingSine/32)),0,M.R(30+35*M.C(WingSine/32))),.2)
    S1.C0 = S1.C0:lerp(CF.N(10,0,-1)*CF.A(M.R(5-0*M.C(WingSine/32)),0,M.R(0+30*M.C(WingSine/32))),.2)
     S2.C0 = S2.C0:lerp(CF.N(20,2,-2)*CF.A(M.R(10-0*M.C(WingSine/32)),0,M.R(15+30*M.C(WingSine/32))),.2)
     S3.C0 = S3.C0:lerp(CF.N(-10,0,-1)*CF.A(M.R(5-0*M.C(WingSine/32)),0,M.R(0-30*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-20.25,2,-1+.05*M.S(WingSine/20))*CF.A(M.R(10-0*M.C(WingSine/32)),0,M.R(-15-30*M.C(WingSine/32))),.2)
...
WingAnims.Big=function()
	...
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120+4000*M.R(WingSine/5))),.1)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120-4000*M.R(WingSine/5))),.1)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,-2,-1.5)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-1000*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,-2,-1.5)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-1000*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+4000*M.R(WingSine/5))),.1)
	S2.C0 = S2.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120+4000*M.R(WingSine/5))),.1)
	S3.C0 = S3.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-4000*M.R(WingSine/5))),.1)
	S4.C0 = S4.C0:lerp(CF.N(0,0,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120-4000*M.R(WingSine/5))),.1)
    
end

WingAnims.Thing=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(2,1.5,-3)*CF.A(0,M.R(40+50*M.C(WingSine/39)),M.R(200+5000*M.C(WingSine/400))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(2,1.5,-6)*CF.A(0,M.R(40+50*M.C(WingSine/39)),M.R(400+5000*M.C(WingSine/400))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,-2,-3)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-180-0*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-15,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(-30-35*M.C(WingSine/32))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(15,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(30+35*M.C(WingSine/32))),.2)
    S1.C0 = S1.C0:lerp(CF.N(2,1.5,-1)*CF.A(0,M.R(40+50*M.C(WingSine/36)),M.R(100+5000*M.C(WingSine/400))),.2)
	S2.C0 = S2.C0:lerp(CF.N(2,1.5,-2)*CF.A(0,M.R(40+50*M.C(WingSine/32)),M.R(150+5000*M.C(WingSine/400))),.2)
	S3.C0 = S3.C0:lerp(CF.N(2,1.5,-4)*CF.A(0,M.R(40+50*M.C(WingSine/36)),M.R(300+5000*M.C(WingSine/400))),.2)
	S4.C0 = S4.C0:lerp(CF.N(2,1.5,-5)*CF.A(0,M.R(40+50*M.C(WingSine/32)),M.R(350+5000*M.C(WingSine/400))),.2)
...
WingAnims.Starp=function()
	...
	S1.C0 = S1.C0:lerp(CF.N(-15*M.C(WingSine/32),1.5-3*M.S(WingSine/32),-1)*CF.A(0,1,M.R(-0+3000*M.C(WingSine/200))),.2)
	S2.C0 = S2.C0:lerp(CF.N(-15*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(0,1,M.R(-10+3000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-15*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-1)*CF.A(0,1,M.R(-30-3000*M.C(WingSine/200))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-15*M.C(WingSine/32),1.5-3*M.S(WingSine/32),-1)*CF.A(0,1,M.R(-40-3000*M.C(WingSine/200))),.2)
...
WingAnims.Happy=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(4.25,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-4.25,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
...
WingAnims.Poke=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(1,-3,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-1,-3,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
...
WingAnims.Poke2=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
	S1.C0 = S1.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(1,-3,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
		S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(0-0*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-1,-3,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
...
S1.C0 = S1.C0:lerp(CF.N(3.50,-2,-1)*CF.A(M.R(20+-500*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
S2.C0 = S2.C0:lerp(CF.N(5.25,-1,-1)*CF.A(M.R(10+500*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
S3.C0 = S3.C0:lerp(CF.N(-3.50,-2,-1)*CF.A(M.R(-20+-500*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
S4.C0 = S4.C0:lerp(CF.N(-5.25,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+500*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
...
WingAnims.Cytus=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.15*M.C(WingSine/32),1.5+.35*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60+5*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1*M.C(WingSine/32),1.5+.25*M.C(WingSine/32),-1)*CF.A(0,0,M.R(90+2.5*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15*M.C(WingSine/32),1.5-.15*M.C(WingSine/32),-1)*CF.A(0,0,M.R(-60-5*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1*M.C(WingSine/32),1.5+.3*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-90-2.5*M.C(WingSine/32))),.2)
    
end
 
WingAnims.Ow=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25*M.C(WingSine/32),1.5-3*M.S(WingSine/32),-1)*CF.A(0,0,M.R(180-900*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25*M.C(WingSine/32),1.5+3*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-180+900*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-10,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(3*M.C(WingSine/32),1.5+10*M.S(WingSine/32),-0)*CF.A(-1,1.8,M.R(60+10*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-3*M.C(WingSine/32),1.5+10*M.S(WingSine/32),-0)*CF.A(-1,1.8,M.R(60+10*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
...
WingAnims.Eagle=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-1,1,-1)*CF.A(0,M.R(100+700*M.C(WingSine/40)),M.R(100+700*M.C(WingSine/40))),.2)
	S2.C0 = S2.C0:lerp(CF.N(-2,2,-2)*CF.A(0,M.R(100+600*M.C(WingSine/40)),M.R(100+600*M.C(WingSine/40))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-4,4,-4)*CF.A(0,M.R(100+400*M.C(WingSine/40)),M.R(100+400*M.C(WingSine/40))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-5,5,-5)*CF.A(0,M.R(100+300*M.C(WingSine/40)),M.R(100+300*M.C(WingSine/40))),.2)
...
WingAnims.Sun=function()
    ...
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(10,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/5)),M.R(60+4000*M.C(WingSine/200))),.2)
	S2.C0 = S2.C0:lerp(CF.N(10,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/5)),M.R(90+4000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(10,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/5)),M.R(-60+4000*M.C(WingSine/200))),.2)
	S4.C0 = S4.C0:lerp(CF.N(10,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/5)),M.R(-90+4000*M.C(WingSine/200))),.2)
...
WingAnims.BigMan=function()
	...
	S1.C0 = S1.C0:lerp(CF.N(.15,500,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(60)),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1,500,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15,500,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(-60)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1,500,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-90)),.2)
    
end

WingAnims.Charge=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(4,.5,-1)*CF.A(M.R(15+0*M.C(WingSine/4)),0,M.R(30+35*M.C(WingSine/4))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-4,.5,-1)*CF.A(M.R(15+0*M.C(WingSine/4)),0,M.R(-30-35*M.C(WingSine/4))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(5,.5,-1)*CF.A(M.R(15+0*M.C(WingSine/4)),0,M.R(40+50*M.C(WingSine/4))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-5,.5,-1)*CF.A(M.R(15+0*M.C(WingSine/4)),0,M.R(-40-50*M.C(WingSine/4))),.2)
    S1.C0 = S1.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+0*M.C(WingSine/4)),0,M.R(0+15*M.C(WingSine/4))),.2)
	S2.C0 = S2.C0:lerp(CF.N(3,-1,-1)*CF.A(M.R(10+0*M.C(WingSine/4)),0,M.R(15+25*M.C(WingSine/4))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+0*M.C(WingSine/4)),0,M.R(0-15*M.C(WingSine/4))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-3,-1,-1+.05*M.S(WingSine/4))*CF.A(M.R(10+0*M.C(WingSine/4)),0,M.R(-15-25*M.C(WingSine/4))),.2)
...
WingAnims.Vehicle=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(.15,-2,-4)*CF.A(M.R(180+0*M.C(WingSine/32)),0,M.R(90)),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1,-3.7,2)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15,-2,1.75)*CF.A(M.R(180+0*M.C(WingSine/32)),0,M.R(-90)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1,-3.7,2)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-90)),.2)
...
WingAnims.Aprins=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(60+5000*M.C(WingSine/400))),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(90+5000*M.C(WingSine/400))),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(-60+5000*M.C(WingSine/400))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(-90+5000*M.C(WingSine/400))),.2)
...
WingAnims.NebG1=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.15,1.5,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(60)),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1,1.5,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15,1.5,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(-60)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1,1.5,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-90)),.2)
...
WingAnims.NebG2=function(div)
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+2000*M.R(WingSine/div))),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120+2000*M.R(WingSine/div))),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,4.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-2000*M.R(WingSine/div))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,4.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120-2000*M.R(WingSine/div))),.2)
...
WingAnims.NebG3=function(mult)
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+WingSine*mult)),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(135+WingSine*mult)),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,1.5,-1.5)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-WingSine*mult)),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,1.5,-1.5)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(135-WingSine*mult)),.2)
    
end

    
	
WingAnims.Sex=function(mult)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(225+WingSine*mult)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(225-WingSine*mult)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-4,-2,-2)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(-90+35*M.C(WingSine/100))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(9,0,-2)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-600*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-9,0,-2)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-600*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(3,1.5,-2)*CF.A(0,M.R(0+0*M.C(WingSine/36)),M.R(180+35*M.C(WingSine/100))),.2)
	S2.C0 = S2.C0:lerp(CF.N(1,-2,-2)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(90+35*M.C(WingSine/100))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-3,1.5,-2)*CF.A(0,M.R(0+0*M.C(WingSine/36)),M.R(-180+35*M.C(WingSine/100))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-6.5,-2,-2)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(-90+35*M.C(WingSine/100))),.2)
    
end

WingAnims.Pyro=function(mult)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(2*M.C(WingSine/32),0+17*M.C(WingSine/32),-1)*CF.A(0,0,M.R(70+500*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(4*M.C(WingSine/32),0+11*M.C(WingSine/32),-1)*CF.A(0,0,M.R(30+500*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,0,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.15*M.C(WingSine/32),1.5+.35*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60+900*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(1*M.C(WingSine/32),0+20*M.C(WingSine/32),-1)*CF.A(0,0,M.R(90+500*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15*M.C(WingSine/32),1.5-.15*M.C(WingSine/32),-1)*CF.A(0,0,M.R(-60-900*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(3*M.C(WingSine/32),0+14*M.C(WingSine/32),-1)*CF.A(0,0,M.R(50+500*M.C(WingSine/32))),.2)
    
end

WingAnims.Blood=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3.5,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+20*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(10.25,.5,-1)*CF.A(M.R(15+35*M.C(WingSine/32)),0,M.R(30+50*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.3,-2,2.7)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(4,0,0)*CF.A(M.R(0+5*M.C(WingSine/32)),0,M.R(-170-2000*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-1,0,-1.5)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(90)),.2)
	S2.C0 = S2.C0:lerp(CF.N(1.25,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+10*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(5.75,.5,-1)*CF.A(M.R(15+25*M.C(WingSine/32)),0,M.R(30+30*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(8,.5,-1)*CF.A(M.R(15+30*M.C(WingSine/32)),0,M.R(30+40*M.C(WingSine/32))),.2)
    
end

WingAnims.Blood2=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(3.5,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+20*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(10.25,.5,-1)*CF.A(M.R(15+35*M.C(WingSine/32)),0,M.R(30+50*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.3,-2,2.7)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(4,0,0)*CF.A(M.R(0+450*M.C(WingSine/32)),0,M.R(-170-400*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-1,500,-1.5)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(1.25,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+10*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(5.75,.5,-1)*CF.A(M.R(15+25*M.C(WingSine/32)),0,M.R(30+30*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(8,.5,-1)*CF.A(M.R(15+30*M.C(WingSine/32)),0,M.R(30+40*M.C(WingSine/32))),.2)
...
WingAnims.Maye=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25,1.5,-.7)*CF.A(M.R(120+20*M.C(WingSine/32)),0,M.R(120)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25,2,-.7)*CF.A(M.R(120+20*M.C(WingSine/32)),0,M.R(-120)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-.3,-2,2.7)*CF.A(M.R(90+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.15,2,-.7)*CF.A(M.R(120+10*M.C(WingSine/32)),0,M.R(60)),.2)
	S2.C0 = S2.C0:lerp(CF.N(.7,2,-.7)*CF.A(M.R(120+15*M.C(WingSine/32)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15,2,-.7)*CF.A(M.R(120+10*M.C(WingSine/32)),0,M.R(-60)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.7,2,-.7)*CF.A(M.R(120+15*M.C(WingSine/32)),0,M.R(-90)),.2)
    
end


WingAnims.Pal=function(div)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/10)),M.R(130+3000*M.C(WingSine/300))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/20)),M.R(230+6000*M.C(WingSine/300))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/20)),M.R(60+1000*M.C(WingSine/100))),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/15)),M.R(100+2000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/10)),M.R(160+4000*M.C(WingSine/100))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+50*M.C(WingSine/15)),M.R(200+5000*M.C(WingSine/200))),.2)
...
WingAnims.Dem=function(mult)
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(0,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-8,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/192)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(8,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/192)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.15*M.C(WingSine/32),1.5+5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60+300*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1*M.C(WingSine/32),1.5+5*M.C(WingSine/32),-1)*CF.A(0,0,M.R(90+300*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15*M.C(WingSine/32),1.5-5*M.C(WingSine/32),-1)*CF.A(0,0,M.R(-60-300*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1*M.C(WingSine/32),1.5+5*M.S(WingSine/32),-1)*CF.A(0,0,M.R(-90-300*M.C(WingSine/32))),.2)
...
WingAnims.Space=function(mult)
    ...
    S1.C0 = S1.C0:lerp(CF.N(4,1.5,-1)*CF.A(0,M.R(5+2.5*M.C(WingSine/36)),M.R(100+1000*M.C(WingSine/200))),.2)
	S2.C0 = S2.C0:lerp(CF.N(4,1.5,-1)*CF.A(0,M.R(5+7.5*M.C(WingSine/32)),M.R(130+1000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(4,1.5,-1)*CF.A(0,M.R(5+2.5*M.C(WingSine/36)),M.R(-10+1000*M.C(WingSine/200))),.2)
	S4.C0 = S4.C0:lerp(CF.N(4,1.5,-1)*CF.A(0,M.R(5+7.5*M.C(WingSine/32)),M.R(-40+1000*M.C(WingSine/200))),.2)
...
WingAnims.Lens=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(.15,1.5,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(60)),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1,1.5,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-700,700,-700)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(-60)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-700,700,-700)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-90)),.2)
...
WingAnims.LustFrench=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(200,1,-10)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S2.C0 = S2.C0:lerp(CF.N(200,1,-10)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(135+WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S3.C0 = S3.C0:lerp(CF.N(200,.70,7)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S4.C0 = S4.C0:lerp(CF.N(200,1,-10)*CF.A(0,M.R(0+2.5*M.C(WingSine/32)),M.R(135-WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
...
WingAnims.Swirl=function()
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,-2,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-0-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-4,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/192)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(4,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/192)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-3,7,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/5)),M.R(2+2000*M.R(WingSine/div))),.2)
	S2.C0 = S2.C0:lerp(CF.N(-3,7,-2)*CF.A(0,M.R(0+7.5*M.C(WingSine/5)),M.R(120+2000*M.R(WingSine/div))),.2)
	S3.C0 = S3.C0:lerp(CF.N(5,-7,4)*CF.A(0,M.R(0+2.5*M.C(WingSine/5)),M.R(1-2000*M.R(WingSine/div))),.2)
	S4.C0 = S4.C0:lerp(CF.N(5,-7,5)*CF.A(0,M.R(0+7.5*M.C(WingSine/5)),M.R(120-2000*M.R(WingSine/div))),.2)
...
WingAnims.Dagger=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(1.5,5,-1)*CF.A(M.R(20+200*M.C(WingSine/10)),0,M.R(60)),.2)
	S2.C0 = S2.C0:lerp(CF.N(300,4.5,-1)*CF.A(M.R(20+200*M.C(WingSine/10)),0,M.R(90)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-1.5,5,-1)*CF.A(M.R(20+200*M.C(WingSine/10)),0,M.R(-60)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-300,4.5,-1)*CF.A(M.R(20+200*M.C(WingSine/10)),0,M.R(-90)),.2)
...
WingAnims.Crazy=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(.20,.7,-5.5)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S2.C0 = S2.C0:lerp(CF.N(.20,.7,-5.5)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(135+WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S3.C0 = S3.C0:lerp(CF.N(.20,.7,1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
	S4.C0 = S4.C0:lerp(CF.N(.20,.7,1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(135-WingSine))*CF.A(0,M.R(90),0)*CF.N(-2,0,0),.2)
...
WingAnims.Empty=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(.10,-1,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0+5*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(.10,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.10,-1,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.10,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
...
WingAnims.Lone=function(mult)
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(4,2,3)*CF.A(0,M.R(50+100*M.C(WingSine/15)),M.R(15+WingSine*mult)),1)
	S2.C0 = S2.C0:lerp(CF.N(1,1,5)*CF.A(0,M.R(50+100*M.C(WingSine/15)),M.R(15+WingSine*mult)),1)
	S3.C0 = S3.C0:lerp(CF.N(4,2,3)*CF.A(0,M.R(50+100*M.C(WingSine/15)),M.R(15-WingSine*mult)),1)
	S4.C0 = S4.C0:lerp(CF.N(1,1,5)*CF.A(0,M.R(50+100*M.C(WingSine/15)),M.R(15-WingSine*mult)),1)
...
WingAnims.Jester=function()
	...
	S2.C0 = S2.C0:lerp(CF.N(4.25,-1,-1)*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+10*M.C(WingSine/32)),0,M.R(0-5*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0s:lerp(CF.N(-4.25,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+15*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
...
WingAnims.Sussy=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(-3,3,-1)*CF.A(M.R(0+1000*M.C(WingSine/32)),0,M.R(95)),.2)
	S2.C0 = S2.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(1)),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(1)),.2)
	S4.C0 = S4.C0:lerp(CF.N(-4,4,-2)*CF.A(M.R(0+1000*M.C(WingSine/32)),0,M.R(95)),.2)
...
WingAnims.Cool=function(mult)
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6,-1,-2)*CF.A(M.R(0+2*M.C(WingSine/20)),0,M.R(-100+20*M.C(WingSine/32))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(9,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(40+9*M.C(WingSine/32))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-9,.5,-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-40-9*M.C(WingSine/32))),.2)
    S1.C0 = S1.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+15*M.C(WingSine/32)),0,M.R(0+10*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(6,-2,-1)*CF.A(M.R(10+20*M.C(WingSine/32)),0,M.R(15+15*M.C(WingSine/32))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+15*M.C(WingSine/32)),0,M.R(0-10*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-6,-2,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+20*M.C(WingSine/32)),0,M.R(-15-15*M.C(WingSine/32))),.2)
...
WingAnims.God=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(6,-2.5,-1)*CF.A(300,M.R(0+2.5*M.C(WingSine/36)),M.R(60+4000*M.C(WingSine/200))),.2)
	S2.C0 = S2.C0:lerp(CF.N(6,-2.5,-1)*CF.A(300,M.R(0+7.5*M.C(WingSine/32)),M.R(90+4000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(6,-2.5,-1)*CF.A(300,M.R(0+2.5*M.C(WingSine/36)),M.R(-60+4000*M.C(WingSine/200))),.2)
	S4.C0 = S4.C0:lerp(CF.N(6,-2.5,-1)*CF.A(300,M.R(0+7.5*M.C(WingSine/32)),M.R(-90+4000*M.C(WingSine/200))),.2)
...
WingAnims.Sus=function()
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,0,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-4,-3,-1)*CF.A(1,M.R(50-50*M.C(WingSine/40)),M.R(10000+5000*M.C(WingSine/200))),.2)
	S2.C0 = S2.C0:lerp(CF.N(-4,-7,-3)*CF.A(1,M.R(50-50*M.C(WingSine/40)),M.R(10000+5000*M.C(WingSine/200))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-4,-10,-5)*CF.A(1,M.R(50-50*M.C(WingSine/40)),M.R(10000+5000*M.C(WingSine/200))),.2)
	S4.C0 = S4.C0:lerp(CF.N(6,-13,-0)*CF.A(0,M.R(0+0*M.C(WingSine/600)),M.R(100+3000*M.C(WingSine/600))),.2)
...
WingAnims.pe=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(-2,-3,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(0,0,-1.5)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(90+5000*M.C(WingSine/400))),.2)
	S3.C0 = S3.C0:lerp(CF.N(2,-3,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0-0*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,-5,-1+.05*M.S(WingSine/35))*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-0-0*M.C(WingSine/32))),.2)
    
end
    
WingAnims.poop=function()
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(12,-4,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(90+0*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-12,-4,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-90-0*M.C(WingSine/32))),.2)
    ...
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,-13.7,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-0-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-0,-16,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(20,-3,-1.5)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(5000+3000*M.C(WingSine/400))),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,-13,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0-0*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,-9,-0+.05*M.S(WingSine/35))*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-0-0*M.C(WingSine/32))),.2)
...
WingAnims.pepe=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(-0,-16,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(0+0*M.C(WingSine/32))),.2)
	S2.C0 = S2.C0:lerp(CF.N(20,-3,-1.5)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(5000+3000*M.C(WingSine/400))),.2)
	S3.C0 = S3.C0:lerp(CF.N(0,10,-1)*CF.A(M.R(-90+0*M.C(WingSine/32)),0,M.R(0-0*M.C(WingSine/32))),.2)
	S4.C0 = S4.C0:lerp(CF.N(0,13,-1+.05*M.S(WingSine/35))*CF.A(M.R(-90+0*M.C(WingSine/32)),0,M.R(-0-0*M.C(WingSine/32))),.2)
...
WingAnims.RushB=function()
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-3,0,5)*CF.A(M.R(0+0*M.C(WingSine/32)),10,M.R(-170-3000*M.C(WingSine/192))),.2)
    ...
    S1.C0 = S1.C0:lerp(CF.N(.15*M.C(WingSine/15),1.5+3*M.S(WingSine/15),-1)*CF.A(0,0,M.R(60+5*M.C(WingSine/15))),.2)
	S2.C0 = S2.C0:lerp(CF.N(.1*M.C(WingSine/15),2+3*M.C(WingSine/15),-1)*CF.A(0,0,M.R(90+2.5*M.C(WingSine/15))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-.15*M.C(WingSine/15),3-3*M.C(WingSine/15),-1)*CF.A(0,0,M.R(-60-5*M.C(WingSine/15))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-.1*M.C(WingSine/15),3.5+3*M.S(WingSine/15),-1)*CF.A(0,0,M.R(-90-2.5*M.C(WingSine/15))),.2)
...
WingAnims.Awake=function(mult)
    ...
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,0,-3)*CF.A(M.R(0+0*M.C(WingSine/10)),0,M.R(-0-5000*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,-500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,-500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    S1.C0 = S1.C0:lerp(CF.N(-1.5,1.5,-2)*CF.A(0,M.R(90+0*M.C(WingSine/10)),M.R(0+WingSine*mult)),1)
	S2.C0 = S2.C0:lerp(CF.N(-1.5,1.5,-2)*CF.A(0,M.R(90+0*M.C(WingSine/10)),M.R(135+WingSine*mult)),1)
	S3.C0 = S3.C0:lerp(CF.N(-1.5,1.5,-4)*CF.A(0,M.R(0+90*M.C(WingSine/15)),M.R(0-WingSine*mult)),1)
	S4.C0 = S4.C0:lerp(CF.N(-1.5,1.5,-4)*CF.A(0,M.R(0+90*M.C(WingSine/15)),M.R(135-WingSine*mult)),1)
...
WingAnims.Kik=function()
    ...
    S1.C0 = S1.C0:lerp(CF.N(-1,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+2000*M.R(WingSine/div))),.2)
	S2.C0 = S2.C0:lerp(CF.N(-1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120+2000*M.R(WingSine/div))),.2)
	S3.C0 = S3.C0:lerp(CF.N(-0,4.5,-2)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-8000*M.R(WingSine/div))),.2)
	S4.C0 = S4.C0:lerp(CF.N(-0,4.5,-2)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120-8000*M.R(WingSine/div))),.2)
...
while true do
	...
	if(NeutralAnims)then
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.A(M.R(-5),0,M.R(-90)),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.A(M.R(-5),0,M.R(90)),Alpha)
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.A(math.min(math.max(Root.Velocity.Y/100,-M.R(45)),M.R(45)),0,0),Alpha)
		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(math.min(math.max(Root.Velocity.Y/100,-M.R(45)),M.R(45)),0,0),Alpha)
	end
	if(legAnims)then 
		LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.A(0,0,M.R(-5)),Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,1,-1)*CF.A(M.R(-5),0,M.R(5)),Alpha)
	end
elseif(State == 'Fall')then
	local Alpha = .1
	local idk = math.min(math.max(Root.Velocity.Y/50,-M.R(90)),M.R(90))
	if(NeutralAnims)then
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.A(M.R(-5),0,M.R(-90)+idk),Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.A(M.R(-5),0,M.R(90)-idk),Alpha)
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.A(math.min(math.max(Root.Velocity.Y/100,-M.R(45)),M.R(45)),0,0),Alpha)
		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(math.min(math.max(Root.Velocity.Y/100,-M.R(45)),M.R(45)),0,0),Alpha)
	end
	if(legAnims)then 
...
elseif(State == 'Paralyzed')then
	local Alpha = .1
	if(NeutralAnims)then
		LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0,Alpha)
		RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0,Alpha)
		ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0,Alpha)
		NECK.C0 = NECK.C0:lerp(NKC0,Alpha)
	end
	if(legAnims)then 
		LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
		RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
	end
elseif(State == 'Sit')then
	...
	if(State == 'Idle')then
		...
		if(Mode=='Nameless')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+0.05*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(0,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+0.1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(87),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-0*M.C(Sine/32)),M.R(90+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,4+0.5*M.C(Sine/32),0)*CF.A(M.R(11+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(0.01),M.R(-0.1),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-0.01),M.R(-0.3),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,.2-0*M.C(Sine/32),-1)*CF.A(-.5,M.R(-.01),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.2-0*M.C(Sine/32),0)*CF.A(-.4,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,-.5+.1*M.C(Sine/13),0)*CF.A(M.R(-36+0*M.S(Sine/64)),M.R(.01),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.2*M.S(Sine/20),0)*CF.A(1,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.2*M.S(Sine/20),0)*CF.A(-.65,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,-0-0*M.C(Sine/32),0)*CF.A(0,M.R(20),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.6-0*M.C(Sine/32),-.3)*CF.A(.7,M.R(-.01),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,-1.5+0.2*M.C(Sine/6),0)*CF.A(M.R(0+5*M.S(Sine/6)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5+5*M.C(Sine/32)),M.R(-0-0*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5-5*M.C(Sine/32)),M.R(0+0*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,1-0*M.C(Sine/32),-.75)*CF.A(1,M.R(-.01),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,1-0*M.C(Sine/32),-.75)*CF.A(1,M.R(-.01),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-.2+.7*M.C(Sine/39),8+1*M.C(Sine/32),0)*CF.A(M.R(-20+5*M.S(Sine/58)),M.R(-5+5*M.C(Sine/42)),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+0*M.S(Sine/32),0)*CF.A(0,M.R(5-.5*M.C(Sine/32)),M.R(6+.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(-.55,M.R(-0),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),-.7)*CF.A(-.5,M.R(-10),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,4+0.3*M.C(Sine/32),0)*CF.A(M.R(-45+2*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-90),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(.9,M.R(-0+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(.9,M.R(-0-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-.25*M.C(Sine/32),0)*CF.A(.7,M.R(-0),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-.25*M.C(Sine/32),0)*CF.A(.7,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,5+3*M.C(Sine/20),0)*CF.A(M.R(0+6*M.S(Sine/64)),M.R(.01),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.2*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-15-25*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.2*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(15+25*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),-1)*CF.A(-1,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,3+1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-30-20*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(160,M.R(5-5*M.C(Sine/32)),M.R(30+20*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,.3-.04*M.C(Sine/32),-1)*CF.A(-.6,M.R(3),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.3-.04*M.C(Sine/32),-1)*CF.A(-.6,M.R(-6),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='Overlord')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,7+.05*M.C(Sine/32),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
			                    	if(M.RNG(1,45)==1)then
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
			                    	else
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/2)),0,0),Alpha)
			                    	end
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+.2*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+.2*M.S(Sine/32),.1)*CF.A(M.R(-20),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.1*M.C(Sine/32),0)*CF.A(0,0,M.R(-2.5)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.5-.1*M.C(Sine/32),-.7)*CF.A(-.5,0,M.R(2.5)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.A(0,0,M.R(-2.5)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.A(0,0,M.R(2.5)),Alpha)
				end
			end
		...
		NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,0)*CF.A(M.R(0),M.R(44.6),M.R(0)),Alpha)
			...
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,M.R(15),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/32),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='Darkness')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+.05*M.C(Sine/32),0)*CF.A(M.R(-5+1*M.S(Sine/64)),M.R(-25),0),Alpha)
			                    	if(M.RNG(1,25)==1)then
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
			                    	else
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
			                    	end
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.1,0+.05*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(-10),M.R(25),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(5),0,0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='The Chosen One')then
			...
			if(NeutralAnims)then	
			                    	...
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-.2+.4*M.C(Sine/39),.5+.2*M.C(Sine/32),0)*CF.A(M.R(-2+5*M.S(Sine/58)),M.R(-15+5*M.C(Sine/42)),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,0,M.R(-15+5*M.S(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,0,M.R(15-5*M.S(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,.5,-.2)*CF.A(0,0,M.R(-5)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.A(0,0,M.R(5)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,1.5+1.5*M.C(Sine/25),0)*CF.A(0,M.R(28),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(-28),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,0,M.R(-1)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(4),M.R(-28),M.R(8)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='V I B E R')then
			if(vaporwaveMode)then
				local Alpha = .1
				if(NeutralAnims)then
					ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,-0.2-.1*M.S(Sine/36),0.6)*CF.A(M.R(74.3+2.5*M.C(Sine/36)),M.R(0),M.R(0)),Alpha)
					LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1,0.8,0)*CF.A(M.R(11.4-5*M.C(Sine/42)),M.R(-3.3),M.R(137.5)),Alpha)
					RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1,0.9,-0.1)*CF.A(M.R(13.7-5*M.C(Sine/42)),M.R(7.7),M.R(-136.2)),Alpha)
					NECK.C0 = NECK.C0:lerp(CF.N(0,1.4,-0.3)*CF.A(M.R(-16.6-5*M.C(Sine/42)),M.R(0),M.R(0)),Alpha)
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.7,-1,0)*CF.A(M.R(37.2+10*M.C(Sine/36)),M.R(0),M.R(24)),Alpha)
						RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.8,-1.1,-0.1)*CF.A(M.R(5.9+5*M.C(Sine/36)),M.R(3.5),M.R(-43.9)),Alpha)
					end
				...
				local Alpha = .3
				if(NeutralAnims)then	
				                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+.05*M.C(Sine/20)+(music.PlaybackLoudness/5000),0)*CF.A(M.R(0+1*M.S(Sine/64)),M.R(35),0),Alpha)
				                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(0+1*M.S(Sine/24)),M.R(-35),0),Alpha)
				                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.A(0,0,M.R(-15+10*M.C(Sine/20))),Alpha)
				                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.A(M.R(75-(music.PlaybackLoudness/7.5)),M.R(5),M.R(35)),Alpha)
				end
				if(legAnims)then 
					if(NeutralAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,-.05*M.C(Sine/20)-(music.PlaybackLoudness/5000),0)*CF.A(0,M.R(25),0),Alpha)
						RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,-.05*M.C(Sine/20)-(music.PlaybackLoudness/5000),0),Alpha)
					else
						LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
						RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
					end
		...
		elseif(Mode=='+Nuclear+')then
			...
			if(NeutralAnims)then	
			                    	...
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,5+.7*M.C(Sine/32),0)*CF.A(M.R(0+1*M.S(Sine/64)),M.R(-15),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(15),1),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.02,0+.05*M.S(Sine/32),-.4)*CF.A(M.R(25),M.R(5-2.5*M.C(Sine/32)),M.R(-65+1.5*M.C(Sine/32))),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(-160-1*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),.4)*CF.A(-5,M.R(-15),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(LHC0*CF.N(1,0-.05*M.C(Sine/32),.4)*CF.A(-5,M.R(15),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='Happy :)')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0,0)*CF.A(0,0,M.R(0+5*M.C(Sine/16))),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(2,0,-M.R(0+5*M.C(Sine/16))),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.15,-0,0)*CF.A(M.R(15),0,M.R(20)),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.A(2,-0,-M.R(5+5*M.S(Sine/16))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.A(0,0,-M.R(0+5*M.C(Sine/16)))*CF.A(M.R(-15),M.R(25),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.A(0,0,-M.R(0+5*M.C(Sine/16))),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,-1+.05*M.C(Sine/25),0)*CF.A(0,M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/1)),M.R(-1),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(RSC0*CF.N(-3,0+.05*M.S(Sine/32),0)*CF.A(M.R(-175),M.R(-5-2.5*M.C(Sine/32)),M.R(25-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.1,0+.05*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(.1,-.5,-.5)*CF.A(-1.5,0,M.R(-30)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(LHC0*CF.N(.9,-.5,-.5)*CF.A(-1.5,0,M.R(30)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='---V a p o r w a v e---')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+.05*M.C(Sine/32),0)*CF.A(M.R(-5+1*M.S(Sine/64)),M.R(-0),0),Alpha)
			                    	if(M.RNG(1,25)==1)then
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
			                    	else
			                    		NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
			                    	...
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(RSC0*CF.N(-3,0-.05*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+.05*M.S(Sine/32),0)*CF.A(M.R(-20),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(-10),M.R(25),0),Alpha)
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-0+8*M.C(Sine/39),30+6*M.C(Sine/32),0)*CF.A(M.R(-2+5*M.S(Sine/58)),M.R(-15+5*M.C(Sine/42)),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,0,M.R(-15+5*M.S(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.A(2,-0,-M.R(5+5*M.S(Sine/16))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,.5,-.7)*CF.A(0,0,M.R(-5)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.A(0,0,M.R(5)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
	        ...
	        local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,15+0.5*M.C(Sine/60),0)*CF.A(0,M.R(15),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(-28),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,0,M.R(-1)),Alpha)
				    RIGHTHIP.C0 = RIGHTHIP.C0:lerp(LHC0*CF.N(1,.5,-.7)*CF.A(0,0,M.R(1)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,10+0.05*M.C(Sine/32),0)*CF.A(M.R(60+7*M.S(Sine/64)),M.R(5),.01),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(5,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(5,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(5.2,M.R(5),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(5.3,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,0+0.1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(RSC0*CF.N(-3,.05-.1*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(.1,.05-.1*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(25-1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
			...
			if(NeutralAnims)then
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,10+1*M.C(Sine/32),0)*CF.A(M.R(-5+1*M.S(Sine/100)),M.R(-0),0),Alpha)
				if(M.RNG(1,25)==1)then
					NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
				end
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(RSC0*CF.N(-3,0-.05*M.S(Sine/32),0)*CF.A(M.R(0),M.R(5-2.5*M.C(Sine/32)),M.R(-100-1.5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+.05*M.S(Sine/32),0)*CF.A(M.R(-20),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
        ...
        elseif(Mode=='[HIDDEN] pp')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,400+0.05*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			...
			if(NeutralAnims)then
			  GotEffect{
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,6+0.1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.2*M.S(Sine/32),0)*CF.A(0,M.R(0+10*M.C(Sine/32)),M.R(-40-3*M.C(Sine/32))),Alpha)
			    RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(LSC0*CF.N(3,0+.2*M.S(Sine/32),0)*CF.A(0,M.R(0+10*M.C(Sine/32)),M.R(40-3*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(-.5,M.R(-10),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.1*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-.1*M.C(Sine/32),0)*CF.A(0,M.R(-5),.3),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,20+4*M.C(Sine/32),0)*CF.A(M.R(0+20*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1,0.9,-0.1)*CF.A(M.R(-13.7-5*M.C(Sine/42)),M.R(7.7),M.R(-150.2)),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),-.7)*CF.A(-.3,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			if(NeutralAnims)then
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-0+6*M.C(Sine/39),20+12*M.C(Sine/32),0)*CF.A(M.R(-2+5*M.S(Sine/58)),M.R(-0+5*M.C(Sine/42)),0),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(0,M.R(20),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(0,M.R(-20),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,7+.3*M.C(Sine/5),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+.03*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+.03*M.S(Sine/32),.1)*CF.A(M.R(-20),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,30+0.05*M.C(Sine/32),0)*CF.A(M.R(0-90*M.S(Sine/100)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-90-10*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.1,0+.05*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.6-0*M.C(Sine/32),-1)*CF.A(-.6,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			    ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-0+3*M.C(Sine/10),4+5*M.C(Sine/10),0)*CF.A(M.R(-2+200*M.S(Sine/58)),M.R(-0+200*M.C(Sine/42)),0),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+1*M.S(Sine/7),0)*CF.A(2,2,M.R(-15+90*M.S(Sine/20))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+1*M.S(Sine/7),0)*CF.A(2,2,M.R(15-90*M.S(Sine/20))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-1*M.C(Sine/7),0)*CF.A(.4,-1,M.R(-5),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-1*M.C(Sine/7),0)*CF.A(-.4,1,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,4+1.5*M.C(Sine/32),0)*CF.A(M.R(25+2*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(30+5*M.C(Sine/32)),M.R(-40-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(-30-5*M.C(Sine/32)),M.R(40+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1.4,-0.1-0*M.C(Sine/32),0)*CF.A(.3,M.R(5),0.5),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0.1-0*M.C(Sine/32),-.3)*CF.A(.8,M.R(-5),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
		...
		elseif(Mode=='Lost Soul')then
			...
			if(NeutralAnims)then
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0+.05*M.C(Sine/32),0.2)*CF.A(M.R(15.5),M.R(20.8),M.R(0)),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.3,1,0.7)*CF.A(M.R(121.8),M.R(14.6),M.R(84.8))*CF.A(M.R(0+3*M.S(Sine/32)),0,0),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(1.3,0.3,-0.1)*CF.A(M.R(121+5*M.C(Sine/44)),M.R(-11.6),M.R(65.5+2.5*M.C(Sine/36))),Alpha)
				if(M.RNG(1,45)==1)then
					NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NECK.C0 = NECK.C0:lerp(CF.N(0,1.5,-0.2)*CF.A(M.R(-15.6),M.R(-20.1),M.R(-5.5))*CF.A(M.R(0+1.5*M.S(Sine/32)),0,0),Alpha)
				end
				if(legAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.6,-1-.05*M.C(Sine/32),0.1)*CF.A(M.R(-27.6),M.R(0),M.R(13.8)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.6,-1.1-.05*M.C(Sine/32),-0.1)*CF.A(M.R(-16.5),M.R(-20),M.R(-5.8)),Alpha)
				end
			elseif(legAnims)then
				LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
		...
		elseif(Mode=='Destroyer-of-Worlds')then
			local Alpha = .1
			if(NeutralAnims)then
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,20+.2*M.C(Sine/24),0)*CF.A(M.R(30+5*M.S(Sine/24)),M.R(16.7),M.R(-9.4)),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.1,1,0.2)*CF.A(M.R(173.3+1*M.S(Sine/28)),M.R(19.9+2*M.S(Sine/28)),M.R(38.7)),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(0.7,0.3,-0.6)*CF.A(M.R(46.8+1*M.S(Sine/28)),M.R(6.4+2*M.S(Sine/28)),M.R(-79.6)),Alpha)
				NECK.C0 = NECK.C0:lerp(CF.N(0,1.4,-0.5)*CF.A(M.R(-40-5*M.S(Sine/24)),M.R(-18.7),M.R(-3.7)),Alpha)
				if(legAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(1.9+7.5*M.S(Sine/24)),M.R(19.2),M.R(-5.7)),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.4,-1,-0.8)*CF.A(M.R(-63.8+7.5*M.S(Sine/24)),M.R(-15),M.R(8.3)),Alpha)
				end
			elseif(legAnims)then
				LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
			...
			elseif(Mode=='::Chill::')then
				local Alpha = .1
				if(NeutralAnims)then
					ROOTJOINT.C0 = ROOTJOINT.C0:lerp(CF.N(0,0.7+.1*M.C(Sine/36),0)*CF.A(M.R(0),M.R(0),M.R(-90-2.5*M.S(Sine/36))),Alpha)
					LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CF.N(-1.2,0.1,0.1)*CF.A(M.R(23),M.R(16.5),M.R(20.6)),Alpha)
					RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CF.N(0.8,1,-0.4)*CF.A(M.R(-162),M.R(-11.2),M.R(-22.6)),Alpha)
					NECK.C0 = NECK.C0:lerp(CF.N(-0.2,1.4,0)*CF.A(M.R(0),M.R(0),M.R(48.9)),Alpha)
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.9,-1.1,-0.2)*CF.A(M.R(-19.3),M.R(6.5),M.R(54.3-7.5*M.S(Sine/36))),Alpha)
						RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CF.N(0.4,-0.9,0)*CF.A(M.R(0),M.R(0),M.R(25.9-7.5*M.S(Sine/36))),Alpha)
					end
			elseif(legAnims)then
				LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
	...
	elseif(State == 'Walk')then
	 ...
	 if(Mode=='[HIDDEN] pp')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,800+0.05*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,4+0.05*M.C(Sine/32),0)*CF.A(M.R(-25+2*M.S(Sine/64)),M.R(5),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(0.01),M.R(-0.1),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-0.01),M.R(-0.3),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
	...
	elseif(State == 'Walk')then
			if(Mode=='Overlord')then
					local Alpha = .1
					if(NeutralAnims)then
						ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0.5,7.5+.05*M.C(Sine/32),0)*CF.A(M.R(-75+8*M.S(Sine/64)),0,0),Alpha)
						NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
						LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
						RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-25),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
					end
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(1.9+7.5*M.S(Sine/24)),M.R(19.2),M.R(-5.7)),Alpha)
				        RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.5-.1*M.C(Sine/32),-.7)*CF.A(-.5,0,M.R(2.5)),Alpha)
			...
			if(Mode=='The Big Black')then
					local Alpha = .1
					if(NeutralAnims)then
						ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0.5,28+.05*M.C(Sine/32),0)*CF.A(M.R(-75+8*M.S(Sine/64)),0,0),Alpha)
						NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
						LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
						RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-25),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
					end
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(1.9+7.5*M.S(Sine/24)),M.R(19.2),M.R(0)),Alpha)
				        RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.5-.1*M.C(Sine/32),-.7)*CF.A(-.5,0,M.R(2.5)),Alpha)
					end
			elseif(State == 'Walk')then
	    if(Mode=='Unmerciful')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,20+12*M.C(Sine/32),0)*CF.A(M.R(-30+6*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5+2.5*M.C(Sine/32)),M.R(-30-1.5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5-2.5*M.C(Sine/32)),M.R(30+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(0,M.R(20),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),-.7)*CF.A(-.5,M.R(-0),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
	    ...
	    if(Mode=='The True Ending')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,10+0*M.C(Sine/32),0)*CF.A(M.R(-45+6*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5+2.5*M.C(Sine/32)),M.R(-30-1.5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5-2.5*M.C(Sine/32)),M.R(30+1.5*M.C(Sine/32))),Alpha)
			end
			...
			local Alpha = .1
			if(NeutralAnims)then	
			ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,-1.5+0.2*M.C(Sine/6),0)*CF.A(M.R(0+3*M.S(Sine/6)),M.R(5),0),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5+5*M.C(Sine/32)),M.R(-0-0*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(1.6,M.R(5-5*M.C(Sine/32)),M.R(0+0*M.C(Sine/32))),Alpha)
			end
	    ...
	    if(Mode=='Supercharged')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,7+2*M.C(Sine/21),0)*CF.A(M.R(-45+6*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5+2.5*M.C(Sine/32)),M.R(-30-1.5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+0.05*M.S(Sine/32),.1)*CF.A(M.R(-70),M.R(5-2.5*M.C(Sine/32)),M.R(30+1.5*M.C(Sine/32))),Alpha)
			end
		...
		if(Mode=='+Nuclear+')then
					local Alpha = .1
					if(NeutralAnims)then
						ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0.5,4+.05*M.C(Sine/60),0)*CF.A(M.R(-75+8*M.S(Sine/64)),0,0),Alpha)
						NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
						RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(-5+5*M.C(Sine/32)),M.R(160+1*M.C(Sine/32))),Alpha)
				        LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0-.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(-160-1*M.C(Sine/32))),Alpha)
					end
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,M.R(15),0),Alpha)
			...
			local Alpha = .1
			if(NeutralAnims)then
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-.3+.4*M.C(Sine/39),28+.2*M.C(Sine/32),0)*CF.A(M.R(-15+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 3)*CF.A(-1,0,M.R(40+2*M.S(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 3)*CF.A(-1,0,M.R(-40-5*M.S(Sine/32))),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
			if(legAnims)then
				LEFTHIP.C0 = LEFTHIP.C0:lerp(CFrame.new(-0.49666214, -0.990924835, 0.00763010979, 1, 0, 0, 0, 1, 0, 0, 0, 1),Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(CFrame.new(0.498336792, -0.303280592, -0.883536756, 1, 0, 0, 0, 0.886996508, 0.461776346, 0, -0.461776316, 0.886996448),Alpha)
			end
	...
	local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,15+1*M.C(Sine/25),0)*CF.A(0,M.R(4),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(-28),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.5,0+.05*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,0,M.R(-1)),Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.5-.1*M.C(Sine/32),-.7)*CF.A(-.5,0,M.R(5)),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
	...
	local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,11+1*M.C(Sine/25),0)*CF.A(0,M.R(4),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(-28),0),Alpha)
			LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
						RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,0+.05*M.S(Sine/32),.1)*CF.A(M.R(-25),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
		...
		if(Mode=='Awakened')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,10+0.05*M.C(Sine/32),0)*CF.A(M.R(-5+7*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.15,-0,0)*CF.A(M.R(15),0,M.R(20)),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(LSC0*CF.N(3,-0,0)*CF.A(M.R(15),0,M.R(-20)),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(5.2,M.R(5),0),Alpha)
			...
			if(Mode=='Determination')then
					local Alpha = .1
					if(NeutralAnims)then
						ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0.5,17.5+3*M.C(Sine/32),0)*CF.A(M.R(-75+8*M.S(Sine/64)),0,0),Alpha)
						NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
						LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
						RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,.05-.1*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(40-1.5*M.C(Sine/32))),Alpha)
					end
					if(legAnims)then
						LEFTHIP.C0 = LEFTHIP.C0:lerp(CF.N(-0.5,-1,0)*CF.A(M.R(1.9+7.5*M.S(Sine/24)),M.R(19.2),M.R(-5.7)),Alpha)
				        RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,.5-.1*M.C(Sine/32),-.7)*CF.A(-.5,0,M.R(2.5)),Alpha)
		...
		if(Mode=='Clarity')then
			...
			if(NeutralAnims)then
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,4.6+0.05*M.C(Sine/32),0)*CF.A(M.R(-35+10*M.S(Sine/64)),M.R(0),0),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			    LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(5,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(5,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(0,M.R(5),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(5.3,M.R(-5),0),Alpha)
				end
			end
		elseif(State == 'Walk')then
		if(Mode=='Pain')then
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,1.5+0.05*M.C(Sine/32),0)*CF.A(M.R(-80+10*M.S(Sine/64)),M.R(0),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0-0*M.C(Sine/32),0)*CF.A(0,M.R(-10),0),Alpha)
				else
					LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0,Alpha)
					RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0,Alpha)
				end
	   ...
	   elseif(State == 'Walk')then
			...
			if(NeutralAnims)then
				...
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-.2+.4*M.C(Sine/39),.5+.2*M.C(Sine/32),0)*CF.A(M.R(-85+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(0,0,M.R(0+5*M.S(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(0,0,M.R(0-5*M.S(Sine/32))),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
			if(legAnims)then
				LEFTHIP.C0 = LEFTHIP.C0:lerp(CFrame.new(-0.49666214, -0.990924835, 0.00763010979, 1, 0, 0, 0, 1, 0, 0, 0, 1),Alpha)
			...
			local Alpha = .1
			if(NeutralAnims)then	
			                    	ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(-.2+.7*M.C(Sine/39),8+1*M.C(Sine/32),0)*CF.A(M.R(-80+0*M.S(Sine/58)),M.R(-5+5*M.C(Sine/42)),0),Alpha)
			                    	NECK.C0 = NECK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
			                    	LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.5,-.1+.05*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
			                    	RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0+0*M.S(Sine/32),0)*CF.A(-1,M.R(5-.5*M.C(Sine/32)),M.R(6+.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LEFTHIP.C0 = LEFTHIP.C0:lerp(RHC0*CF.N(-1,0-0*M.C(Sine/32),0)*CF.A(-.55,M.R(-0),0),Alpha)
		...
		if(Mode=='YES')then
			...
			local Alpha = .2
			if(NeutralAnims)then
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,.05+Change/4*M.C(Sine/(wsVal/2)),0)*CF.A(M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*forwardvelocity,M.R(0+5*M.C(Sine/wsVal)),M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*sidevelocity+M.R(0-1*M.C(Sine/wsVal))),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0,Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(.3,-0+.2*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(-.3,-0+.2*M.S(Sine/32),.1)*CF.A(M.R(-20),M.R(5-2.5*M.C(Sine/32)),M.R(-35+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-movement/15*M.C(Sine/wsVal)/2,(-.1+movement/15*M.C(Sine/wsVal))*(.5+.5*forwardvelocity))*CF.A((M.R(-10*forwardvelocity+Change*5-movement*M.C(Sine/wsVal))+-(movement/10)*M.S(Sine/wsVal))*forwardvelocity,0,(M.R(Change*5-movement*M.C(Sine/wsVal))+-(movement/10)*M.S(Sine/wsVal))*(sidevec/(Hum.WalkSpeed*2))),Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0+movement/15*M.C(Sine/wsVal)/2,(-.1-movement/15*M.C(Sine/wsVal))*(.5+.5*forwardvelocity))*CF.A((M.R(-10*forwardvelocity+Change*5+movement*M.C(Sine/wsVal))+(movement/10)*M.S(Sine/wsVal))*forwardvelocity,0,(M.R(Change*5+movement*M.C(Sine/wsVal))+(movement/10)*M.S(Sine/wsVal))*(sidevec/(Hum.WalkSpeed*2))),Alpha)
				end
			...
			if(NeutralAnims)then
				ROOTJOINT.C0 = ROOTJOINT.C0:lerp(RJC0*CF.N(0,.05+Change/4*M.C(Sine/(wsVal/2)),0)*CF.A(M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*forwardvelocity,M.R(0+5*M.C(Sine/wsVal)),M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*sidevelocity+M.R(0-1*M.C(Sine/wsVal))),Alpha)
				NECK.C0 = NECK.C0:lerp(NKC0,Alpha)
				LEFTAHOULDER.C0 = LEFTAHOULDER.C0:lerp(LSC0*CF.N(0,0,0)*CF.A(M.R(0+55*(movement/8)*M.S(Sine/wsVal))*forwardvelocity,0,0),Alpha)
				RIGHTSHOULDER.C0 = RIGHTSHOULDER.C0:lerp(RSC0*CF.N(0,0,0)*CF.A(M.R(0-55*(movement/8)*M.S(Sine/wsVal))*forwardvelocity,0,0),Alpha)
			end
			if(legAnims)then 
				LEFTHIP.C0 = LEFTHIP.C0:lerp(LHC0*CF.N(0,0-movement/15*M.C(Sine/wsVal)/2,(-.1+movement/15*M.C(Sine/wsVal))*(.5+.5*forwardvelocity))*CF.A((M.R(-10*forwardvelocity+Change*5-movement*M.C(Sine/wsVal))+-(movement/10)*M.S(Sine/wsVal))*forwardvelocity,0,(M.R(Change*5-movement*M.C(Sine/wsVal))+-(movement/10)*M.S(Sine/wsVal))*(sidevec/(Hum.WalkSpeed*2))),Alpha)
				RIGHTHIP.C0 = RIGHTHIP.C0:lerp(RHC0*CF.N(0,0+movement/15*M.C(Sine/wsVal)/2,(-.1-movement/15*M.C(Sine/wsVal))*(.5+.5*forwardvelocity))*CF.A((M.R(-10*forwardvelocity+Change*5+movement*M.C(Sine/wsVal))+(movement/10)*M.S(Sine/wsVal))*forwardvelocity,0,(M.R(Change*5+movement*M.C(Sine/wsVal))+(movement/10)*M.S(Sine/wsVal))*(sidevec/(Hum.WalkSpeed*2))),Alpha)
	...
	if(data.User==data.Local)then
		local syncStuff={
			NeutralAnims;
			legAnims;
			{NECK.C0,ROOTJOINT.C0,RIGHTHIP.C0,RIGHTSHOULDER.C0,LEFTHIP.C0,LEFTAHOULDER.C0};
			{NECK.C1,ROOTJOINT.C1,RIGHTHIP.C1,RIGHTSHOULDER.C1,LEFTHIP.C1,LEFTAHOULDER.C1};
			Sine;
			movement;
			walking;	
			Change;
