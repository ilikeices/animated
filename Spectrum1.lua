...
function bosschatfunc(text,color,watval)
	...
	txtlb.Position = UDim2.new(0,0,0.75 + 1,0)
	local txtlb2 = Instance.new("TextLabel",scrg)
	txtlb2.Text = modet.Text.."Theo_TheoBenzo"
	txtlb2.Font = "Arcade"
	txtlb2.TextColor3 = Color3.new(0,0,0)
	txtlb2.TextStrokeTransparency = 0
	txtlb2.BackgroundTransparency = 1
...
Show.Position = UDim2.new(0, 0, .85, 0)
Show.Size = UDim2.new(0, 45, 0, 45)
Show.Font = "Sarpanch"
Show.Text = "M1"
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename("PANDEMIC",Color3.new(0,1,0),Color3.new(0.8,1,0.5),"Bodoni")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename("DESTRUCTION",BrickColor.new("Really black").Color,BrickColor.new("Bright bluish green").Color,"SciFi")
